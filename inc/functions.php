    ...
    function printPrivateItems()
    {
        ...
        ?>
            <div class="publicItem">
                ...
                <p class="publicFileSize"><?php echo $row["fileSize"] ?>kb</p>
                <div>
                    <button onclick="window.open('../media/img/20220419_090346.jpg')" class="filterButton filter1 pointer download"><span class="material-symbols-outlined">download</span></button>
