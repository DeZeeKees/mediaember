...
<body>
    ...
    <div class="registerContainer">
        <form action="" method="post" class="register-form">
            ...
            <input class="logRegInputs googlefont" type="password" name="passwordRegister" placeholder="Password" required>
            <input class="logRegInputs googlefont" type="password" name="cPasswordRegister" placeholder="Confirm Password" required>
